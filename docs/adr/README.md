...
| [0031](0031-corpus-catalog-corruption-fail-closed-audit.md) | Fail-closed catalog reads: a per-caller audit of `load_sources`'s corruption recovery | Accepted | 2026-08-27 |
