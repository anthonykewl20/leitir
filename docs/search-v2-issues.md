...
- [ ] No new dependency; suite remains >= current 2347 passed, 0 failed.
...
## Engineering workflow gates
- [ ] Suite >= current 2347 passed, ruff clean, mypy clean, scorecard `pass`.
...
## Engineering workflow gates
- [ ] Zero behavior change; suite >= current 2347 passed, ruff, mypy, scorecard `pass`.
