...
def test_bounded_matching_lines_terminates_on_pattern_that_evades_the_shape_check():
    ...
    """
    # Intentional hostile input: this pattern is the SUBJECT of the test, proving
    # MAX_REGEX_LINE_LENGTH stops it before it ever reaches re.search. Code scanning
    # flags it as py/redos by design; the alert is dismissed as "used in tests".
