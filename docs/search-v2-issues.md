...
- [ ] No new dependency; suite remains >= current 2329 passed, 0 failed.
...
## Engineering workflow gates
- [ ] Suite >= current 2329 passed, ruff clean, mypy clean, scorecard `pass`.
...
## Engineering workflow gates
- [ ] Zero behavior change; suite >= current 2329 passed, ruff, mypy, scorecard `pass`.
